...
<div style="display: flex;justify-content: flex-end;margin-right: 5%;">
    <a class="btn btn-link" href="{{ route('home') }}">პროდუქტების გვერდი</a>
                ...
                @if (Auth::user()->id)
                    <div style="display: flex;flex-direction: row;">
                        <div style="margin-left: 1%">
                            <a href="{{ route('singleStore',["id"=>$store->id ]) }}" class="btn btn-outline-info">
                            ნახვა
                            </a>
                        </div>
                        ...
                        <div style="margin-left: 1%">
                            <a href="{{ route('editstore',["id"=>$store->id ]) }}" class="btn btn-outline-info">
                            განახლება
                            </a>
                        </div>
                    </div>
